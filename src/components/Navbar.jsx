...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-max flex flex-row justify-between items-center p-4 bg-white relative">
      ...
      <div className={`w-full h-max md:flex ${openMenu? 'flex': 'hidden'} z-10 md:justify-center md:relative absolute right-0 top-[100%] justify-end`}>
        ...
        <div className="md:h-[47px] h-max md:w-[60%] w-full min-w-[500px] bg-[#F5F5F5] shadow-[0px_4px_4px_0px_#00000040]">
          <ul className="h-full w-full flex md:flex-row justify-around items-center flex-col md:gap-0 gap-2">
            <li className="font-[700] text-[100%] font-cormorant cursor-pointer md:p-[1px] py-2 text-center px-2 md:w-max w-full rounded-md transition-all ease-linear hover:bg-gray-300">
              Home
            </li>
            <li className="font-[700] text-[100%] font-cormorant cursor-pointer md:p-[1px] py-2 text-center px-2 md:w-max w-full rounded-md transition-all ease-linear hover:bg-gray-300">
              About Us
      ...
      <div className="w-max  sm:h-[40px] h-[30px] flex flex-row items-center gap-2">
        <button className="w-[9vw] sm:min-w-[80px] min-w-[60px]  h-full  bg-[#583781] font-cormorant font-[600] text-[15px] text-white rounded-[5px] transition-all ease-linear hover:bg-[#8456bb] hover:text-gray-50">
          Login
        </button>
